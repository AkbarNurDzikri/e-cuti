        ...
        <div class="col-md text-end">
            <?php if ($_SESSION['user']['gender'] == 'L') : ?>
                ...
                <div class="collapse" id="collapseExample3">
                    <button type="button" class="badge bg-dark border-0 my-2" data-bs-toggle="modal" data-bs-target="#gantiPassw<?= $_SESSION['user']['id_user'] ?>">
                        Ganti Password
                    </button> <br>
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <?php if ($transcuti['bukti_cuti'] !== null) : ?>
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" class="badge bg-dark border-0 mt-2" data-bs-toggle="modal" data-bs-target="#buktiCuti<?= $transcuti['id'] ?>">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form <?= $c['nama_cuti']; ?></h5>
                    ...
                    <?php if ($c['nama_cuti'] == 'Cuti Tahunan') : ?>
                        <?php if ($_SESSION['user']['nama_dept'] == 'HRD') : ?>
                            <form action="<?= BASEURL; ?>/transcuti/store" method="POST">
                                ...
                                <select name="karyawan_id" id="karyawan_id" class="form-select mb-3" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="saldo_awal" class="form-label">Sisa Hak Cuti User HRD</label>
                                        <?php
...
<!-- Modal -->
<div class="modal fade" id="gantiPassw<?= $_SESSION['user']['id_user'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
