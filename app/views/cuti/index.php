    ...
    <div class="row">
        ...
        <div class="col-md-6 text-end">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#create">
                <i class="fa-solid fa-plus"></i> Jenis Cuti
            </button>
        </div>
            ...
            <?php foreach ($data['cuti'] as $cuti) : ?>
                <tr class="text-center">
                    ...
                    <td class="text-center">
                        <button class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#edit<?= $cuti['id']; ?>"><i class="fa-solid fa-pencil"></i></button>
                        <button class="btn btn-danger mb-2" data-bs-toggle="modal" data-bs-target="#confirmDelete<?= $cuti['id']; ?>"><i class="fa-solid fa-trash-can"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
...
<?php foreach ($data['cuti'] as $cuti) : ?>
    <!-- Modal -->
    <div class="modal fade" id="edit<?= $cuti['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
...
<?php foreach ($data['cuti'] as $cuti) : ?>
    <!-- Modal -->
    <div class="modal fade" id="confirmDelete<?= $cuti['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
