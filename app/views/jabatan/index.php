    ...
    <div class="row">
        ...
        <div class="col-md-6 text-end">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#create">
                <i class="fa-solid fa-plus"></i> Jabatan
            </button>
        </div>
        ...
        <tbody>
            ...
            <?php foreach ($data['jabatan'] as $jabatan) : ?>
                <tr class="text-center">
                    ...
                    <td><?= $jabatan['jobdesc']; ?></td>
                    <td class="text-center">
                        <button class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#edit<?= $jabatan['id']; ?>"><i class="fa-solid fa-pencil"></i></button>
                        <button class="btn btn-danger mb-2" data-bs-toggle="modal" data-bs-target="#confirmDelete<?= $jabatan['id']; ?>"><i class="fa-solid fa-trash-can"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
...
<?php foreach ($data['jabatan'] as $jabatan) : ?>
    <!-- Modal -->
    <div class="modal fade" id="edit<?= $jabatan['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="<?= BASEURL; ?>/jabatan/update" method="POST">
                        ...
                        <input type="hidden" name="created_at" value="<?= $jabatan['created_at']; ?>">
                        <div class="row">
                            <div class="col-md mb-3">
                                <label for="nama_jabatan" class="form-label">Nama Jabatan</label>
                                <input type="text" class="form-control" name="nama_jabatan" id="nama_jabatan" value="<?= $jabatan['nama_jabatan']; ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md mb-3">
                                <label for="jobdesc" class="form-label">Jobdesc</label>
                                <input type="text" class="form-control" name="jobdesc" id="jobdesc" value="<?= $jabatan['jobdesc']; ?>">
                            </div>
                        </div>
                        <div class="modal-footer">
...
<?php foreach ($data['jabatan'] as $jabatan) : ?>
    <!-- Modal -->
    <div class="modal fade" id="confirmDelete<?= $jabatan['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md text-center">
                            ...
                            <h3 class="font-primary mt-5">Yakin hapus data <b><?= $jabatan['nama_jabatan']; ?></b>?</h3>
                            <p class="text-muted font-primary">Data ini akan dihapus secara permanen !</p>
                            <a class="btn btn-danger mt-4" href="<?= BASEURL; ?>/jabatan/delete/<?= $jabatan['id']; ?>" style="width: 100px;">Yes</a>
