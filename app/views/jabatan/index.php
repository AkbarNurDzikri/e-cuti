                ...
                <?php foreach ($data['jabatan'] as $jabatan) : ?>
                    <tr class="text-center">
                        ...
                        <td class="text-center">
                            <button class="btn btn-primary mb-2" data-toggle="modal" data-target="#edit<?= $jabatan['id']; ?>"><i class="fa-solid fa-pencil"></i></button>
                            <button class="btn btn-danger mb-2" data-toggle="modal" data-target="#confirmDelete<?= $jabatan['id']; ?>"><i class="fa-solid fa-trash-can"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
...
<?php foreach ($data['jabatan'] as $jabatan) : ?>
    <!-- Modal -->
    <div class="modal fade" id="edit<?= $jabatan['id']; ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
...
<?php foreach ($data['jabatan'] as $jabatan) : ?>
    <!-- Modal -->
    <div class="modal fade" id="confirmDelete<?= $jabatan['id']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
